...
np.set_printoptions(threshold=np.nan)#多维数组强制打印全部输出
...
class FaceNet(object):
    ...
    def load_model(self, model_dir_path):
        #该加载的模型是通过siamese_demo_train.py训练好的
        self.model = faceRecoModel(input_shape=(3, 96, 96))#faceRecoModel是inception_blocks_v2.py中的一个函数
...
def main():
    ...
    database = {}
    database["danielle"] = fnet.img_to_encoding(image_dir_path + "/chenaifang1.jpg")
    '''
    ...
    '''
    fnet.verify(image_dir_path + "/chenaifang2.jpg", "danielle", database)
